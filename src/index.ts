...
import { adminAuditLogs, authTokens, badges, businessInterests, commentLikes, comments, contentReports, destinationPhotos, destinations, follows, identityVerifications, notifications, postLikes, postMedia, posts, profiles, recognitions, routeStops, routes, savedDestinations, savedPosts, sessions, stamps, travelerInterests, userBadges, userBlocks, userRecognitions, userStamps, users, visits } from './db/schema';
